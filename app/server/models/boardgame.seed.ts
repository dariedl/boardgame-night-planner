import type { Boardgame } from "../../shared/boardgame";
...
export function getBoardgames(): Array<Boardgame> {
  return boardgames;
}

export function getBoardgame(boardgameId: string): Boardgame | undefined {
  return boardgames.find((boardgame) => boardgame.id === boardgameId);
}
