...
const boardgames = [
	{
		...
		description: 'Vertreibt kooperative als Naturgeister, europäische Kolonisten von eurer Insel.',
		minPlayers: 2,
		maxPlayers: 4,
		weight: 'heavy',
	},
	...
	{
		title: 'Flügelschlag',
		description: 'Sammelt die meisten Punkte mit verschiedenen schönen Vogelkarten.',
		urlLink:
	...
	},
	{
		...
		urlLink: 'https://mytoys.scene7.com/is/image/myToys/ext/15290150-01.jpg?$rtf_mt_prod-main_xl$',
		minPlayers: 4,
		maxPlayers: 4,
		weight: 'light',
	},
...
async function createUsers() {
	const saltRounds = parseInt(process.env.HASH_SALT_ROUNDS ?? 'No Saltnumber defined');
